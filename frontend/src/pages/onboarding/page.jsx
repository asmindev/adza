...
import { Loader2, CheckCircle2, Circle, ChefHat, Salad } from "lucide-react";
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {categories.map((category) => {
                            ...
                            return (
                                <Card
                                    key={category.id}
                                    className={`cursor-pointer transition-all duration-150 border p-0 ${
                                        isSelected
                                ...
                                >
                                    <CardContent className="text-center p-4">
                                        <div className="flex items-center gap-2 h-full">
                                            ...
                                            <h3
                                                className={`font-medium text-md transition-colors whitespace-nowrap ${
                                                    isSelected
                                                        ? "text-primary"
                                                        : "text-foreground"
                                                }`}
